...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("SERVER=.\\SQLEXPRESS;DATABASE=AnswersDB;INTEGRATED SECURITY=TRUE; User Id=;Password=;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362CF201D01F");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF275893E7");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A029DA040");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF4D7647C29");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC040BCA02");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A5566D542C9");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A3DF373BB");
